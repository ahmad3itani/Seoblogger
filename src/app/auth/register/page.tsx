      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card rounded-2xl p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full h-10 pl-10 pr-4 rounded-lg border border-border/50 bg-background/50 text-sm focus:outline-none focus:ring-2 focus:ring-[#6C4CF1]/50 focus:border-[#6C4CF1]/50"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  minLength={6}
                  className="w-full h-10 pl-10 pr-10 rounded-lg border border-border/50 bg-background/50 text-sm focus:outline-none focus:ring-2 focus:ring-[#6C4CF1]/50 focus:border-[#6C4CF1]/50"
                />
                <button
                  type="button"
          ...
          <p className="text-[11px] text-muted-foreground text-center">
            ...
            <Link href="/terms" className="text-[#6C4CF1] hover:underline">Terms of Service</Link>{" "}
            and{" "}
            <Link href="/privacy" className="text-[#6C4CF1] hover:underline">Privacy Policy</Link>
          </p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          ...
          <Link href="/auth/login" className="text-[#6C4CF1] hover:text-violet-500 font-medium">
            Sign in
          </Link>
        </p>
      </div>
