    ...
    return (
        <div className="max-w-5xl space-y-6">
                ...
                <div className="flex gap-2">
                    ...
                    {!isEditing ? (
                        ...
                        <Button
                            ...
                            onClick={handleSave}
                            disabled={isSaving}
                            className="bg-[#6C4CF1] hover:bg-[#6C4CF1]/90 text-white"
                        >
                            {isSaving ? (
                    ...
                    {hasQualityPass ? (
                        <Link href={`/dashboard/quality-pass?articleId=${article.id}`}>
                            <Button
                                size="sm"
                                variant="outline"
                                className="border-[#6C4CF1]/30 text-[#6C4CF1] hover:bg-[#6C4CF1]/5"
                            >
            ...
            <Card className="glass-card">
                ...
                <CardContent>
                    <div
                        className="prose prose-invert max-w-none prose-headings:text-foreground prose-p:text-muted-foreground prose-a:text-[#6C4CF1] prose-strong:text-foreground"
