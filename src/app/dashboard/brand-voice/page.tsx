    ...
    return (
        <div className="space-y-6 max-w-5xl">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <Button onClick={handleOpenCreate} className="bg-[#F97316] hover:bg-violet-700 text-white shadow-lg shadow-violet-500/20">
            ...
            {isLoading ? (
                ...
                <div className="glass-card rounded-xl p-12 text-center border-dashed">
                    ...
                    <Button onClick={handleOpenCreate} variant="outline" className="border-[#F97316]/30 text-violet-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {profiles.map((profile) => (
                        <Card key={profile.id} className={`glass-card relative overflow-hidden transition-all duration-300 hover:border-[#F97316]/50 ${profile.isDefault ? 'border-[#F97316]/50 ring-1 ring-[#F97316]/20 shadow-lg shadow-violet-500/10' : ''}`}>
                            {profile.isDefault && (
                                <div className="absolute top-0 right-0">
                                    <div className="bg-[#F97316] text-[10px] font-bold px-3 py-1 rounded-bl-lg flex items-center shadow-md">
                ...
                <DialogContent className="sm:max-w-[600px] glass-card border-border/50">
                    ...
                    <DialogFooter>
                        ...
                        <Button
                            ...
                            className="bg-[#F97316] hover:bg-violet-700 text-white"
                        >
