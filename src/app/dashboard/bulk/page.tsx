                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <Select value={selectedProfileId} onValueChange={(v) => v && handleProfileSelect(v)}>
                                    <SelectTrigger className="bg-[#F97316]/5 border-[#F97316]/20 text-violet-100">
                            ...
                            <div className="flex flex-col gap-2 relative">
                                <button
                                    ...
                                    className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm transition-all ${includeImages ? "bg-orange-500/20 text-violet-300 border border-[#F97316]/30" : "bg-muted/20 text-muted-foreground border border-border/50"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm transition-all ${autoInterlink ? "bg-orange-500/20 text-violet-300 border border-[#F97316]/30" : "bg-muted/20 text-muted-foreground border border-border/50"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm transition-all ${includeFaq ? "bg-orange-500/20 text-violet-300 border border-[#F97316]/30" : "bg-muted/20 text-muted-foreground border border-border/50"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm transition-all ${includeToc ? "bg-orange-500/20 text-violet-300 border border-[#F97316]/30" : "bg-muted/20 text-muted-foreground border border-border/50"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm transition-all ${includeSchema ? "bg-orange-500/20 text-violet-300 border border-[#F97316]/30" : "bg-muted/20 text-muted-foreground border border-border/50"
                                        }`}
                                >
                            ...
                            {jobs.map((job, idx) => (
                                <div key={idx} className="flex items-center justify-between p-4 rounded-lg bg-muted/20 border border-border/50 hover:bg-muted/30 transition-colors">
                                    <div className="flex items-center gap-4 flex-1">
                                        ...
                                        {job.status === "processing" && <Loader2 className="w-5 h-5 text-[#F97316] animate-spin" />}
