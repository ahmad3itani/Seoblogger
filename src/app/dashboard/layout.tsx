            ...
            >
                ...
                {currentPlan === "free" && (
                    <div className="px-3 pb-2">
                        <Link href="/pricing">
                            <div className="p-3 rounded-lg bg-gradient-to-br from-violet-500/10 to-indigo-500/10 border border-violet-500/20 hover:border-violet-500/40 transition-colors cursor-pointer">
                ...
                <main className="flex-1 overflow-y-auto p-4 lg:p-6 bg-[#F5F5F5]">
                    {isCurrentRouteBlocked ? (
                        <div className="flex flex-col items-center justify-center h-full max-w-md mx-auto text-center">
                            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-500/10 to-indigo-500/10 flex items-center justify-center mb-6 border border-violet-500/20">
